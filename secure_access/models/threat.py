...
class Threat(BaseModel):
    ...
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="The descriptive label for the threat name.")
    type: Optional[StrictStr] = Field(default=None, description="The type of the threat.")
